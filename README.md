...
class EsteSoyYo:
  def __init__(self):
    self.Nombre = "Omar"
    self.Apellido = "Flores"
    self.Edad = 23
    self.Estudios = "Lic. en Ing. de Sistemas y Computación"
  
  def Aptitudes(self):
    self.SO = ["Windows","Linux"]
    self.Lenguajes = {
        "Python": "Avanzado",
        "C++": "Intermedio",
        "C": "Intermedio",
        "Java": "Básico"}
    self.Idiomas = "Ingles (Básico)"
    return "Disponible para trabajar en proyectos de Código Abierto"
  ```
---
